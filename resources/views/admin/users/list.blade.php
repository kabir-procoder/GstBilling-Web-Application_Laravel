  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
      	...
      	<a href="{{ url('register') }}" class="btn btn-primary" style="margin-bottom: 15px;">Add</a>
      	<a href="{{ url('admin/users/trashlist') }}" class="btn btn-warning text-white" style="margin-bottom: 15px;">Trash</a>
                  	...
                  	@forelse($getRecord as $value)
                        ...
                        <td style="text-wrap: nowrap;">{{ date('d-m-y', strtotime($value->updated_at)) }}</td>
	                      <td style="text-wrap: nowrap;">
	                      	<a href="{{ url('admin/users/edit/'.$value->id) }}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
	                      	<a href="{{ url('admin/users/trash/'.$value->id) }}" onclick="return confirm('Are you sure you want to trash this item?');" class="btn btn-warning text-white"><i class="fas fa-trash-alt"></i></a>
	                      </td>
	                    </tr>
                      @empty
                      <tr>
